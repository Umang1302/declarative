    ...
    <div className={`w-full h-full px-2 ${cabin.className}`}>
      ...
      <div className="border-2 border-[#c4c4c4]">
        ...
        <div className="relative my-2 w-full">
          ...
          <input
            type="text"
            id="simple-search"
            className="bg-[#F2F2F2] border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block mx-3 w-[96%] outline-none pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-black dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
      ...
      <div className="border-2 border-[#c4c4c4] mt-3">
        {rules[+selectRule] ? (
          <>
            <div
              className={` flex items-center h-[20%] px-6 py-3 text-black justify-between ${
            ...
            <div className="mb-6 w-full py-3">
              <div className="bg-[#EEEEEE] px-10 py-4">
                      ...
                      <div className="border-[1px] flex flex-col items-center py-1 ">
                        ...
                        >
                          <Checkbox
                            ...
                            checked={
                              multiValueArray.indexOf("Reporting") !== -1
                            }
                            type="checkbox"
                          />
                          Reporting
                        ...
                        >
                          <Checkbox
                            ...
                            checked={
                              multiValueArray.indexOf("Marketing") !== -1
                            }
                            type="checkbox"
                          />
                          Marketing
