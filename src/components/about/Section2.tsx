...
export default function Section1() {
  ...
  return (
    ...
    >
      <div className="w-[90%] landingBox  px-10 py-5">
        ...
        <div className="mt-6">
          <div className="w-full flex gap-x-8 h-[220px]">
            ...
            <div className="mt-3">
              ...
              <div  className="text-[#555] w-[250px] flex flex-col gap-y-4 mt-5">
                <p>Founder and CEO</p>
                <p>
                  25+ years experience in Enterprise Data Strategy, Governance,
